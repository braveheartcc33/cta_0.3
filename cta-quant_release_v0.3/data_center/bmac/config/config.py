...
class CFG:
    ...
    BINANCE_EXGINFO_PATH = {
        ...
        'coin_futures': os.path.join(_CUR_DIR,
                                     'binance_exginfo_coin_futures.json'),
        'usdt_futures': os.path.join(_CUR_DIR,
                                     'binance_exginfo_usdt_futures.json')
    }
    ...
    def BINANCE_CANDLE_SPLITS(self):
        ...
        def _load():
            return json.load(open(os.path.join(_CUR_DIR,
                                               'binance_candle_split.json')))
    ...
    def BINANCE_EXGINFO(self):
        ...
        def _load():
            return {k: json.load(open(p))
                    for k, p in self.BINANCE_EXGINFO_PATH.items()}
